...
namespace Bora.Repository.EFCore.Migrations
{
    ...
    [Migration("20240723161727_AddAccountResponsibility")]
    partial class AddAccountResponsibility
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountResponsibility", b =>
                {
                    ...
                    b.HasKey("AccountId", "ResponsibilityId");

                    b.HasIndex("ResponsibilityId");

                    b.ToTable("AccountResponsibility");
                });
            ...
            modelBuilder.Entity("AccountResponsibility", b =>
                {
                    b.HasOne("Bora.Entities.Account", null)
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bora.Entities.Responsibility", null)
                        .WithMany()
