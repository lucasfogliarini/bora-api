...
namespace Bora.Tests.Unit
{
    public class EventTests : TestsBase
    {
        ...
        [InlineData("aa https://www.blueticket.com.br/evento/35590/21-set-house-mag-festival bb", "https://www.blueticket.com.br/evento/35590/21-set-house-mag-festival", "www.blueticket.com.br")]
        public void GetTicketUrl(string description, string expectedTicketUrl, string expectedTicketDomain)
        {
            ...
            var ticketUrl = @event.GetTicketUrl();
            var ticketDomain = @event.GetTicketDomain();
        ...
        public void GetSpotifyUrl(string description, string expectedSpotifyUrl)
        {
            ...
            var spotifyUrl = @event.GetSpotifyUrl();
        ...
        public void GetInstagramUrl(string description, string expectedInstagramUrl)
        {
            ...
            var instagramUrl = @event.GetInstagramUrl();
        ...
        public void GetYouTubeUrl(string description, string expectedYouTubeUrl)
        {
            ...
            var youTubeUrl = @event.GetYouTubeUrl();
        ...
        public void GetWhatsAppGroupChat(string description, string expectedWhatsAppChat)
        {
            ...
            var whatsAppChatUrl = @event.GetWhatsAppGroupChat();
        ...
        [InlineData(" https://twitch.tv/lucasfogliarini ", "https://meet.google.com/gpp-qisy-hpi", "", "https://twitch.tv/lucasfogliarini")]
        ...
        public void GetConferenceUrl(string location, string hangoutLink, string? description, string expectedConferenceUrl)
        {
            ...
            var conferenceUrl = @event.GetConferenceUrl();
        ...
        public void GetDiscount(string summary, decimal expectedDiscount)
        {
            ...
            var discount = @event.GetDiscount();
